...
Installing Gitpod Self-Hosted on your own infrastructure works much like any other piece of kit running on Kubernetes. We have produced a series of [installation guides](/docs/self-hosted/latest/installation-guides) will work most Kubernetes clusters.
