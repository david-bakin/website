<script>
  ...
  import LinkIconExternal from "../ui-library/link-icon-external.svelte";
</script>
  ...
  >
    ...
    <div>
      ...
      <p class="mb-x-small">
        ...
        through of our public Notion pages.
      </p>
      <ButtonsWrapper>
        <LinkIconExternal
          icon="💻"
        ...
        <LinkIconExternal
          icon="🔨"
          href="https://www.notion.so/gitpod/How-we-develop-e8ce7e562478458a9223eb9b797415b2"
          variant="gray"
        >
          How we develop
        </LinkIconExternal>
