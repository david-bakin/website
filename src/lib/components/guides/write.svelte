...
<div
  class="bg-card stroked dark:bg-card shadow-default rounded-4xl max-w-2xl py-small px-xx-small sm:px-small mx-auto mt-huge mb-xx-large text-center"
>
  ...
  <LinkButton
    ...
    target="_blank">Start Guide</LinkButton
  >
</div>
