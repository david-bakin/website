  ...
  items: [
    {
      ...
      content:
        'We are happy to manage Gitpod for you to let you focus on the important things, but if you want to <a href="/docs/self-hosted">self-host</a> on your infrastructure, that\'s possible too, without user limit.',
    },
    {
      title:
