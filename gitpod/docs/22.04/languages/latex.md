...
First, you will probably want to install LaTeX in Gitpod. To do this, add a new file to your repository called [.gitpod.Dockerfile](../config-docker), and add the following content to it:
...
Next, create a file called [.gitpod.yml](../config-gitpod-file) and add the following to it:
