...
2. Extensions defined in [`gitpod.yml`](../config-gitpod-file)
...
1. [JetBrains IDE's](../ides-and-editors) via [JetBrains Gateway](./jetbrains-gateway)
2. [VS Code in the browser](./vscode-browser) and [VS Code on desktop](./vscode)
3. [Command-line](./command-line) based editors such as Vim

Please see the [IDEs & editors](../ides-and-editors) documentation for more details.
